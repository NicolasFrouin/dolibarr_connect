...
/**
 *  \file       session_agenda.php
 *  \ingroup    connect
 *  \brief      Tab of events on Session
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Session")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Session"), -1, $object->picto);
